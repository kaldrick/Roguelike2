...
namespace LibNoise.Unity
{
    ...
    public struct Gradient
    {
        ...
        static Gradient()
        {
			...
			Gradient._test.m_data = new List<KeyValuePair<double, Color>>();
			Gradient._test.m_data.Add (new KeyValuePair<double, Color>(-1.0, new Color(0.9f, 0.9f, 0.9f)));
			Gradient._test.m_data.Add (new KeyValuePair<double, Color>(-0.8, new Color(0.7f, 0.7f, 0.85f)));
			Gradient._test.m_data.Add (new KeyValuePair<double, Color>(-0.5, new Color(0.6f, 0.6f, 0.6f)));
			Gradient._test.m_data.Add (new KeyValuePair<double, Color>(-0.1, new Color(0.4f, 0.4f, 0.2f)));
			Gradient._test.m_data.Add (new KeyValuePair<double, Color>(0.1, new Color(0.6f, 0.6f, 0.1f)));
			Gradient._test.m_data.Add (new KeyValuePair<double, Color>(0.5, new Color(0.3f, 0.5f, 0.3f)));
			Gradient._test.m_data.Add (new KeyValuePair<double, Color>(1.0, new Color(0.1f, 0.8f, 0.1f)));
			Gradient._test.m_inverted = true;
		...
		public static Gradient Test
		{
			get { return Gradient._test; }	
		}
        #endregion
